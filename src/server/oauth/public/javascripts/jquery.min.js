...
(function(e, t) {
  ...
  function ft(e, t, n) {
    ...
    if (t.nodeType) return v.grep(e, (e, r) => (e === t) === n);
    if (typeof t === 'string') {
      const r = v.grep(e, e => e.nodeType === 1);
      if (it.test(t)) return v.filter(t, r, !n);
      t = v.filter(t, r);
    }
    return v.grep(e, (e, r) => v.inArray(e, t) >= 0 === n);
  }
  function lt(e) {
    let t = ct.split('|'),
  ...
  function en(e, t, n, r) {
    let i = n === (r ? 'border' : 'content') ? 4 : t === 'width' ? 1 : 0,
      s = 0;
    for (; i < 4; i += 2)
  ...
  function tr(e) {
    return v.isWindow(e)
      ? e
      : e.nodeType === 9 ? e.defaultView || e.parentWindow : !1;
  }
  var n,
    r,
    i = e.document,
  ...
  (v.fn = v.prototype = {
    ...
    pushStack(e, t, n) {
      const r = v.merge(this.constructor(), e);
      return (
        (r.prevObject = this),
    ...
    map(e) {
      return this.pushStack(v.map(this, (t, n) => e.call(t, n, t)));
    },
    end() {
  ...
  v.extend({
    ...
    acceptData(e) {
      const t = e.nodeName && v.noData[e.nodeName.toLowerCase()];
  ...
  v.fn.extend({
    ...
    v.extend({
      ...
      prop(e, n, r) {
        ...
        return (
          ...
          r !== t
            ? s && 'set' in s && (i = s.set(e, r, n)) !== t ? i : (e[n] = r)
            : s && 'get' in s && (i = s.get(e, n)) !== null ? i : e[n]
        );
      },
      propHooks: {
        tabIndex: {
          get(e) {
            ...
            return n && n.specified
              ? parseInt(n.value, 10)
              : z.test(e.nodeName) || (W.test(e.nodeName) && e.href) ? 0 : t;
          },
        },
      },
    }),
    ...
    v.support.hrefNormalized ||
      v.each(['href', 'src', 'width', 'height'], (e, n) => {
  ...
  (v.event = {
    ...
    simulate(e, t, n, r) {
      const i = v.extend(new v.Event(), n, {
        type: e,
        isSimulated: !0,
        originalEvent: {},
      });
    ...
    v.each({ mouseenter: 'mouseover', mouseleave: 'mouseout' }, (e, t) => {
      v.event.special[e] = {
        delegateType: t,
        bindType: t,
        handle(e) {
        ...
        setup() {
          ...
          v.event.add(this, 'click._submit keypress._submit', e => {
            ...
            r &&
              ...
              (v.event.add(r, 'submit._submit', e => {
                e._submit_bubble = !0;
              }),
    ...
    v.support.focusinBubbles ||
      v.each({ focus: 'focusin', blur: 'focusout' }, (e, t) => {
        let n = 0,
          r = function(e) {
    ...
    v.fn.extend({
      ...
      toggle(e) {
        let t = arguments,
          ...
          r = 0,
          i = function(n) {
            const i = (v._data(this, `lastToggle${e.guid}`) || 0) % r;
            return (
    ...
    (function(e, t) {
      ...
      var n,
        ...
        B = `:(even|odd|eq|gt|lt|nth|first|last)(?:\\(${O}*((?:-\\d)?\\d*)${
          O
        }*\\)|)(?=[^-]|$)`,
        j = new RegExp(`^${O}+|((?:^|[^\\\\])(?:\\\\.)*)${O}+$`, 'g'),
        F = new RegExp(`^${O}*,${O}*`),
  ...
  (Nt.optgroup = Nt.option),
    ...
    v.fn.extend({
      ...
      wrapAll(e) {
        ...
        if (this[0]) {
          const t = v(e, this[0].ownerDocument)
            .eq(0)
            .clone(!0);
          ...
          if (t || v.acceptData(i)) {
            ...
            if (n) {
              ...
              a[r] &&
                ...
                f
                  ? delete i[u]
                  : i.removeAttribute ? i.removeAttribute(u) : (i[u] = null),
                v.deletedIds.push(r));
            }
          }
      },
  ...
  v.fn.extend({
    css(e, n) {
      return v.access(
        this,
        (e, n, r) => (r !== t ? v.style(e, n, r) : v.css(e, n)),
        e,
        n,
        arguments.length > 1,
      );
    ...
    v(() => {
      v.support.reliableMarginRight ||
        (v.cssHooks.marginRight = {
          get(e, t) {
            return v.swap(e, { display: 'inline-block' }, () => {
    ...
    v.each({ margin: '', padding: '', border: 'Width' }, (e, t) => {
      (v.cssHooks[e + t] = {
        expand(n) {
          let r,
  ...
  (v.Animation = v.extend(Kn, {
    ...
    (Yn.prototype = {
      ...
      cur() {
        const e = Yn.propHooks[this.prop];
    ...
    v.fn.extend({
      ...
      animate(e, t, n, r) {
        let i = v.isEmptyObject(e),
          s = v.speed(t, n, r),
          o = function() {
            const t = Kn(this, v.extend({}, e), s);
            i && t.stop(!0);
          };
    ...
    v.expr &&
      ...
      (v.expr.filters.animated = function(e) {
        return v.grep(v.timers, t => e === t.elem).length;
      });
  const er = /^(?:body|html)$/i;
  (v.fn.offset = function(e) {
    ...
    v.fn.extend({
      ...
      offsetParent() {
        return this.map(function() {
          let e = this.offsetParent || i.body;
    ...
    v.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, (e, n) => {
      const r = /Y/.test(n);
      v.fn[e] = function(i) {
        return v.access(
          this,
    ...
    v.each({ Height: 'height', Width: 'width' }, (e, n) => {
      v.each({ padding: `inner${e}`, content: n, '': `outer${e}` }, (r, i) => {
        v.fn[i] = function(i, s) {
          let o = arguments.length && (r || typeof i !== 'boolean'),
